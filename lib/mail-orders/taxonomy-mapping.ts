...
export const SUB_PRODUCT_ORDER: Record<string, string[]> = {
  ...
  "PROMISE":          ["PROMISE ENAMEL", "PROMISE EXTERIOR", "PROMISE SHEEN EXTERIOR", "PROMISE SMARTCHOICE EXT", "PROMISE SMARTCHOICE EXT PRIMER", "PROMISE INTERIOR", "PROMISE SHEEN INTERIOR", "PROMISE SMARTCHOICE INT", "PROMISE SMARTCHOICE INT PRIMER", "PROMISE SMARTCHOICE ACRYLIC DISTEMPER", "PROMISE FREEDOM 2IN1 PRIMER", "PROMISE PRIMER"],
...
const ALIASES: Record<string, string> = {
  ...
  "HISHEEN/HISHEEN":          "HISHEEN, HI-SHEEN, WS HISHEEN, WS HI-SHEEN, PROTECT DUSTPROOF HI-SHEEN",
...
const DISPLAY_LABEL: Record<string, string> = {
  ...
  "GLOSS/GLOSS":              "Gloss",
  "SATIN/SUPER SATIN":        "Super Satin (Oil Satin / Satin Finish)",
  "SATIN/SATIN STAY BRIGHT":  "Satin Stay Bright (WB Satin)",
  ...
  "HISHEEN/HISHEEN":          "Dulux WS Hi-Sheen",
