...
# v110 · Schema v27.40 · September 2026 · updated 2026-09-22 · Lives in: orbit-oms/docs/
...
orders                     workflowStage, slotId, originalSlotId, dispatchSlotDeadline,
                           ...
                           sides — SEVEN exist now (OrderPickedBy / OrderRemovedBy / OrderRestoredBy /
                           OrderPickEarlyReleasedBy / OrderInvoicedBy / OrderPickVisibleBy /
                           OrderLoadedBy; hiddenById is a bare Int with no relation) — an unnamed
                           one is a Prisma ambiguity ERROR.
