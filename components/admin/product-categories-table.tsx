  ...
  return (
    <>
      <div className="flex items-center justify-between mb-4">
        <h1 className="text-lg font-bold text-brand-700">Product Categories</h1>
        <div className="flex gap-2">
          ...
          <Button size="sm" onClick={openAdd} className="bg-brand-600 hover:bg-brand-700 text-white">+ Add Category</Button>
        </div>
          ...
          <form onSubmit={handleSave} className="oa-sheet-form flex flex-col gap-5 px-6 pb-0">
            ...
            <div className="flex items-center justify-between py-3 px-4 rounded-lg border border-[#e5e7eb] bg-gray-50">
              <div>
                ...
                <div className="text-xs text-gray-500 mt-0.5">Inactive categories are hidden from SKU forms</div>
              </div>
              <Switch
            ...
            <div className="sticky bottom-0 bg-white border-t border-[#e5e7eb] -mx-6 px-6 py-4 flex gap-3 mt-6">
              ...
              <Button type="submit" className="flex-1 h-10 text-sm bg-brand-600 hover:bg-brand-700 text-white rounded-lg font-semibold" disabled={saving}>{saving ? "Saving…" : editTarget ? "Save Changes" : "Create Category"}</Button>
            </div>
          </form>
        </SheetContent>
      </Sheet>
