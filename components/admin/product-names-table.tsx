    ...
    <>
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex gap-2">
          ...
          <Button size="sm" onClick={openAdd} className="bg-ink-900 hover:bg-ink-700 text-white">+ Add Product Name</Button>
        </div>
      ...
      <div className="flex items-center gap-3 mb-4">
        <Label className="text-sm text-gray-600 shrink-0">Filter by category:</Label>
          ...
          <TableBody>
            ...
            {displayedRows.map((row) => (
              <TableRow key={row.id}>
                ...
                <TableCell className="text-gray-600 text-sm">{row.category.name}</TableCell>
          ...
          <form onSubmit={handleSave} className="oa-sheet-form flex flex-col gap-5 px-6 pb-0">
            ...
            <div className="flex items-center justify-between py-3 px-4 rounded-lg border border-[#e5e7eb] bg-gray-50">
              <div>
                ...
                <div className="text-xs text-gray-500 mt-0.5">Inactive names are hidden from SKU forms</div>
              </div>
              <Switch
