        ...
        {showSuggestion ? (
          ...
          <div className="flex h-[30px] flex-1 items-stretch overflow-hidden rounded-md">
            <button
              ...
              className="flex flex-1 items-center justify-center gap-1.5 border border-ink-100 bg-white px-2.5 text-[11.5px] font-semibold text-brand-700 transition-colors hover:bg-brand-50"
            >
            ...
            <div className="relative flex">
              <button
                ...
                className="flex w-[26px] items-center justify-center border border-l-0 border-ink-100 bg-white text-brand-700 transition-colors hover:bg-brand-50"
              >
