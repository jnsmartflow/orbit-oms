...
export const TRANSPARENT_ART: ReadonlySet<string> = new Set([
  // TILE art — public/PO/board/
  "gloss",
  "super-satin",
  "promise-enamel",
  "pu-enamel",
  // MEMBER art — public/PO/drawer/. "pu-enamel" is above and serves BOTH:
  // artPath picks the folder from which resolver is asking, so one slug in
  // this set covers the tile and the member.
  "product-5in1-gloss",
  "product-lustre",
]);
